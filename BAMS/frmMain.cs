...
namespace BAMS
{
    public partial class frmMain : Form
    {
        ...
        {
            var StudentAttendanceReport = new StudentAttendanceReport();
            StudentAttendanceReport.ShowDialog();
        }
        ...
        {
            //DefaultPercentageProfit defaultPercentageSellingPrice = new DefaultPercentageProfit();
            //defaultPercentageSellingPrice.ShowDialog();
        }
    }
}
